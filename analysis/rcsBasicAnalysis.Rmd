...
par(pty="s")
plot(pgamPOC, type="l", lwd=6, axes=F, ylim=c(.4, .6), ylab="p(gamble)", xlab="Outcome (t-1) amount", main="Effect size of past outcome on risk-taking (n=124)")
axis(1, at = c(1,3,5), labels = c("$0", "$30.50", "$60.98"), lwd=6)
axis(2, at = c(.6,.55, .5, .45, .4), labels = c(.60,.55, .50,.45, .40), lwd=6)
abline(h=0.5, col="grey", lwd=6, lty="dotted")
dev.off()
...
par(pty="s")
plot(pgamSignedShift, type="l", lwd=6, axes=F, ylim=c(.4, .6), ylab="p(gamble)", xlab="Shift amount", main="Effect size of signed shift on risk-taking (n=124)")
axis(1, at = c(1:5), labels = c("-$20", "-$10", "$0", "+$10", "+$20"), lwd=6)
axis(2, c(.6,.55, .5, .45, .4), labels = c(.60,.55, .50,.45, .40), lwd=6)
abline(h=0.5, col="grey", lwd=6, lty="dotted")
dev.off()
...
plot(PgamSub1EarnExp, type="l", col="darkgreen", lwd=6, ylim=c(.4,.6), ylab="p(gamble)", xlab="trial", main="risk taking as a function\n of earnings and expectations; round1", axes=F, cex.lab=1, xlim=c(1,131))
abline(a=.5, b=0, lty="dotted", col="darkgrey", lwd=6)
#lines(PgamSub2EarnExp, col="darkred", lwd=6);
#lines(PgamSub3EarnExp, col="darkblue", lwd=6);
lines(PgamSub4EarnExp, col="darkred", lwd=6);
lines(PgamSub5EarnExp, col="darkblue", lwd=6);
lines(PgamSub6EarnExp, col="darkorange", lwd=6);
#lines(PgamSub7EarnExp, col="purple4", lwd=6);


legend("bottomright", legend=c("sub 1", "sub 71","sub 86", "sub 116"), lty = 1, lwd=6, bty="n", col=c("darkgreen","darkred",  "darkblue", "darkorange"), cex=.75)
...
axis(1, at=c(1,131),tick =T, cex.axis = 1.25, cex=2, lwd = 6)
axis(2, tick =T, cex.axis = 1.25, cex=2, lwd = 6)
dev.off()
...
plot(pgamStratPOC_lowReap[1:5], type="l", lwd=6, col="goldenrod1", ylab="P(gamble)", xlab="Outcome(t-1) amount", cex=2, ylim=c(.29, .61), axes=F, main="low reap: poc x strat"); # low reappraisal natural
...
plot(pgamStratPOC_modReap[1:5], type="l", lwd=6, col="goldenrod1", ylab="P(gamble)", xlab="Outcome(t-1) amount", cex=2, ylim=c(.29, .61), axes=F, main="moderate reap: poc x strat"); # high reappraisal natural
...
plot(pgamStratPOC_highReap[1:5], type="l", lwd=6, col="goldenrod1", ylab="P(gamble)", xlab="Outcome(t-1) amount", cex=2, ylim=c(.29, .61), axes=F, main="high reap: poc x strat"); # high reappraisal natural
lines(pgamStratPOC_highReap[6:10], lwd=6, col="tomato1", lty=2); # avg reappraisal, strategy
axis(1, at=c(1,3,5), label=c("$0", "$30.50", "$61"), lwd=6, cex=1.5)
axis(2, at = c(.3, .4, .5, .6), labels= c(.30, .40, .50, .60), lwd =6, cex=1.5)
abline(a=.5, b=0, col="darkgrey", lty="dotted", lwd=6)
legend("bottomleft", legend=c("Act Natural","Ignore Context"),lty=c(1,2), bty="n", col=c("goldenrod1", "tomato1"), cex=1.5, lwd=6)
