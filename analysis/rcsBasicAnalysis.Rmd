...
# participants rated, on average, that they were able to follow instructions about 73-74% of the time with a slightly higher rating reported for the strategy condition
...
# for participants who did natural then strategy, they are slightly slower in the first round (natural) but the difference is very small
...
# for participants who did strategy then natural, they are slightly slower in the first round (strategy) relative to second (natural) but the difference is very very small
...
# across all conditions, participants are faster in the second round, a difference that is largest for repeat instructions and this pattern still holds (although weaker) for going from natural to strategy and strategy to natural.
...
summary(model7_posNegShift) # AIC: 14648
...
summary(model8_posShift) # AIC: 14659
...
# even subsetting the data in the no strategy condition -- no effect of positive shift
