...
model_pocSignedShiftEarnExp_strategy_pred2= glm(formula = choice ~ 0 + pastOC1sc*strategyRecode + signedShiftsc*strategyRecode + earnNormalizedOverall*strategyRecode + 
    linExpectation*strategyRecode, family = "binomial", data = rdmDFclean, offset = predModel2)
summary(model_pocSignedShiftEarnExp_strategy_pred2)
# AIC: 30225 - slight improvement from adding strategy
# main effects hold up. 
# trending interaction between past outcome and strategy (p=.098)
# trending interaction between signfed shift and strategy (p=.089)

# interact everything with round:
model_pocSignedShiftEarnExp_round_pred2= glm(formula = choice ~ 0 + pastOC1sc*roundRecode + signedShiftsc*roundRecode + earnNormalizedOverall*roundRecode + 
    linExpectation*roundRecode, family = "binomial", data = rdmDFclean, offset = predModel2)
summary(model_pocSignedShiftEarnExp_round_pred2)
# AIC: 30233
# no interactions with round

# interact everything with round and strategy
model_pocSignedShiftEarnExp_strategyRound_pred2= glm(formula = choice ~ 0 + pastOC1sc*strategyRecode*roundRecode + signedShiftsc*strategyRecode*roundRecode + earnNormalizedOverall*strategyRecode*roundRecode + 
    linExpectation*strategyRecode*roundRecode, family = "binomial", data = rdmDFclean, offset = predModel2)
summary(model_pocSignedShiftEarnExp_strategyRound_pred2)
# AIC: 30238

model_pocSignedShiftEarnExp_strategyRoundsome_pred2= glm(formula = choice ~ 0 + pastOC1sc*strategyRecode*roundRecode + signedShiftsc*strategyRecode*roundRecode + earnNormalizedOverall + 
    linExpectation, family = "binomial", data = rdmDFclean, offset = predModel2)
summary(model_pocSignedShiftEarnExp_strategyRoundsome_pred2)
# AIC: 30234
# trending interaction between strategy and signed shift and strat x shift x round
# round is not interacting with poc so we will remove that interaction

model_pocSignedShiftEarnExp_strategyPOC_stratRoundShift_pred2= glm(formula = choice ~ 0 + pastOC1sc*strategyRecode + signedShiftsc*strategyRecode*roundRecode + earnNormalizedOverall + linExpectation, family = "binomial", data = rdmDFclean, offset = predModel2)
summary(model_pocSignedShiftEarnExp_strategyPOC_stratRoundShift_pred2);
# AIC: 30232
# same results as above
# adding round isn't improving model

# best model with strat x temporal context is one with just strategy
model_pocSignedShiftEarnExp_strategyPocShift_pred2= glm(formula = choice ~ 0 + pastOC1sc*strategyRecode + signedShiftsc*strategyRecode + earnNormalizedOverall + linExpectation, family = "binomial", data = rdmDFclean, offset = predModel2)
summary(model_pocSignedShiftEarnExp_strategyPocShift_pred2)
#AIC: 30227 - removing strategy from earn and exp increases AIC

# Best temporal context x strategy model is one that interacts strategy with each timescale, even though earnings x strat and exp x strat are not significant. 


# Let's look at strategy x base model 2: model_pocSignedShiftEarnExp_pocIntxn_pred2 
# interact everything with strategy
model_pocSignedShiftEarnExp_pocIntxn_strategy_pred2  = glm(formula = choice ~ 0 + pastOC1sc*strategyRecode + signedShiftsc*strategyRecode + earnNormalizedOverall*pastOC1sc*strategyRecode + linExpectation*pastOC1sc*strategyRecode, family = "binomial", data = rdmDFclean, offset = predModel2)
summary(model_pocSignedShiftEarnExp_pocIntxn_strategy_pred2);
...
# interact everything with round
model_pocSignedShiftEarnExp_pocIntxn_round_pred2  = glm(formula = choice ~ 0 + pastOC1sc*roundRecode + signedShiftsc*roundRecode + earnNormalizedOverall*pastOC1sc*roundRecode + linExpectation*pastOC1sc*roundRecode, family = "binomial", data = rdmDFclean, offset = predModel2)
summary(model_pocSignedShiftEarnExp_pocIntxn_round_pred2);
#AIC: 30214 -  worse when adding round 
# no main effect of round, 
# several interactions with round, poc, earnings and expectations

# so is strategy interacting with neighborhood and round is interacting with immediate/global?

# adding strategy x round to everything:
model_pocSignedShiftEarnExp_pocIntxn_strategyRound_pred2  = glm(formula = choice ~ 0 + pastOC1sc*strategyRecode*roundRecode + signedShiftsc*strategyRecode*roundRecode + earnNormalizedOverall*pastOC1sc*strategyRecode*roundRecode + linExpectation*pastOC1sc*strategyRecode*roundRecode, family = "binomial", data = rdmDFclean, offset = predModel2)
summary(model_pocSignedShiftEarnExp_pocIntxn_strategyRound_pred2);
#AIC: 30220
