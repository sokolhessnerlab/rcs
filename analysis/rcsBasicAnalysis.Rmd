...
# just interactino ERQ supp and reap with strategy
# base model 1
pocShiftEarnExp_ERQxStratyOnly = glm(choice~0 + pastOC1sc*strategyRecode + signedShiftsc*strategyRecode + earnNormalizedOverall*strategyRecode + linExpectation*strategyRecode + ERQsuppSC*strategyRecode + ERQreappSC*strategyRecode, data=rdmDFclean, family="binomial",offset=predModel2);
...
# base model 2
pocShiftEarnExp_pocIntnx_ERQxStratOnly = glm(choice~0 + pastOC1sc*linExpectation*strategyRecode + signedShiftsc*strategyRecode + pastOC1sc*earnNormalizedOverall*strategyRecode + ERQsuppSC*strategyRecode + ERQreappSC*strategyRecode, data=rdmDFclean, family="binomial",offset=predModel2);
...
# base model 1
pocShiftEarnExp_ERQreapXstratOnly = glm(choice~0 + pastOC1sc*strategyRecode + signedShiftsc*strategyRecode + earnNormalizedOverall*strategyRecode + linExpectation*strategyRecode + ERQreappSC*strategyRecode, data=rdmDFclean, family="binomial",offset=predModel2);
summary(pocShiftEarnExp_ERQreapXstratOnly);
# AIC = 29762 - removing supp from base model 1 has better AIC
# significant interaction between strategy and ERQreappraisal. 
# no interaction with suppression
# main contextual effects still present
...
# base model 2
pocShiftEarnExp_pocIntnx_ERQreapXstratOnly = glm(choice~0 + pastOC1sc*linExpectation*strategyRecode + signedShiftsc*strategyRecode + pastOC1sc*earnNormalizedOverall*strategyRecode + ERQreappSC*strategyRecode, data=rdmDFclean, family="binomial",offset=predModel2);
summary(pocShiftEarnExp_pocIntnx_ERQreapXstratOnly);
#AIC = 29750 - removing supp has better AIC for model 2 as well
...
# 
# # base model 2
# pocShiftEarnExp_pocIntnx_ERQspanMotivxStrat = glm(choice~0 + pastOC1sc*linExpectation*strategyRecode + signedShiftsc*strategyRecode + pastOC1sc*earnNormalizedOverall*strategyRecode + ERQsuppSC*strategyRecode + ERQreappSC*strategyRecode + motivationNumeric*strategyRecode + compositeSpanScore*strategyRecode, data=rdmDFclean, family="binomial",offset=predModel2);
# summary(pocShiftEarnExp_pocIntnx_ERQxStratyOnly);
# # AIC: 29753
...
# base model 1
pocShiftEarnExp_ERQreapXstrat_3timescales = glm(choice~0 + pastOC1sc*strategyRecode*ERQreappSC + signedShiftsc*strategyRecode*ERQreappSC + earnNormalizedOverall*strategyRecode*ERQreappSC + linExpectation*strategyRecode*ERQreappSC, data=rdmDFclean, family="binomial",offset=predModel2);
...
# base model 2
pocShiftEarnExp_pocIntnx_ERQreapXstrat_3timescales = glm(choice~0 + pastOC1sc*linExpectation*strategyRecode*ERQreappSC + signedShiftsc*strategyRecode*ERQreappSC + pastOC1sc*earnNormalizedOverall*strategyRecode*ERQreappSC, data=rdmDFclean, family="binomial",offset=predModel2);
summary(pocShiftEarnExp_pocIntnx_ERQreapXstrat_3timescales);
#AIC = 29747-  adding erq reap interaction to strartegy improves model
...
# because there isn't an interaction between strategy x erq and other tiemscales besides poc, let's remove those interactions from the models:

# base model 1
pocShiftEarnExp_ERQreapXstratXpoc = glm(choice~0 + pastOC1sc*strategyRecode*ERQreappSC + signedShiftsc*strategyRecode + earnNormalizedOverall*strategyRecode + linExpectation*strategyRecode, data=rdmDFclean, family="binomial",offset=predModel2);
summary(pocShiftEarnExp_ERQreapXstratXpoc);
# AIC: 29755 better AIC removing strat and ERQ from global timescales but the results are similar and now we are seeing the main effects of temporal context as expected.
# still seeing interaction betwen poc x strat, strat x reap, strat x poc x reap


# recode reappraisal to be -1 to 1 because having reap be .3-1 doesn't allow us to look at the difference between high and low reappraisers
...
# average person -> negative past outcome effect, theres no intnx bt strategy and reappraisal
...
# base model 2:
pocShiftEarnExp_pocIntnx_ERQreapXstratXpoc = glm(choice~0 + pastOC1sc*strategyRecode*ERQreappSC + linExpectation*pastOC1sc + signedShiftsc*strategyRecode + pastOC1sc*earnNormalizedOverall, data=rdmDFclean, family="binomial",offset=predModel2);
summary(pocShiftEarnExp_pocIntnx_ERQreapXstratXpoc);
# AAIC: 29743 - removing the interactions with ERQ at global timescale improves model
...
pocBeta = basemodel2_erqStrat_temporalcontext$coefficients[1]
stratBeta =  basemodel2_erqStrat_temporalcontext$coefficients[2]
reapBeta =  basemodel2_erqStrat_temporalcontext$coefficients[3]
shiftBeta = basemodel2_erqStrat_temporalcontext$coefficients[5]
pocStratBeta = basemodel2_erqStrat_temporalcontext$coefficients[7]
pocReapBeta = basemodel2_erqStrat_temporalcontext$coefficients[8]
stratReapBeta = basemodel2_erqStrat_temporalcontext$coefficients[9]
pocExpBeta = pocReapBeta = basemodel2_erqStrat_temporalcontext$coefficients[10]
pocEarnBeta = pocReapBeta = basemodel2_erqStrat_temporalcontext$coefficients[12]
pocStratReapBeta = pocReapBeta = basemodel2_erqStrat_temporalcontext$coefficients[13]
