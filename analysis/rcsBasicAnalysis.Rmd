...
# Because we find an interaction bewteen strategy and round, we will account for both strategy and round in the contextual models as well.
...
rdmDFclean$motivationNumeric= as.numeric(rdmDFclean$overallMotivation)/max(as.numeric(rdmDFclean$overallMotivation));
...
# there is now an interaction between poc and strategy - where stratgegy enhance past outcome effect?
