...
RT_roundStrat= lmer(RT ~ roundRDM + strategyRecode + roundRDM*strategyRecode + (1|subID), data= rdmDFclean);
...
# round 1, nat: -.1*-1 + -.03*-1 +  .03*-1*-1 = .2 weight on RT
# round 1, strat: -.1*-1 + -.03*1 +  .03*-1*1 = .04 weight on RT
# round 2, nat: -.1*1 + -.03*-1 +  .03*-1*1 = -.1 weight on RT
# round 2, strat: -.1*1 + -.03*1 +  .03*1*1 = -.1 weight on RT
# in round 2, everyone is faster regardless of strategy
# in round 1, faster in strategy relative to natural

RT_roundStrat_500ms= lmer(RT ~ roundRDM + strategyRecode + roundRDM*strategyRecode + (1|subID), data= rdmDFclean[rdmDFclean$RT>.5,]);
