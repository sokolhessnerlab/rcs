...
#is complex span related to ERQ 
...
# will want to nod that we want to be careful about null effects and that we would want to follow up on those later but that we can see some changes suggests that we are powered to see others (and should take seriously the null effects)
...
# poc effect for low reappraisers = -.2
# poc effect for high reappraisers = -.2 + 0.13 = -.07

# poc x strategy effect of low reappraisers = -.06
# poc x strategy effect for high reappraisers = -.06 + 0.119375 = .06
