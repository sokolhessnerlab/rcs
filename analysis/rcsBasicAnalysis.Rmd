...
#FIX THESE HISTOGRAMS TO BE BETTER LABELED
...
hist(rcsSubLevelWide_clean$rdmRoundsIndepNumeric, breaks=seq(from=0.5, to = 7.5, by = 1), main= "RDM round independence\nn=124; mean = 4.99", xlab="independence ratings (1-7)") #, xlim=c(1,7))

# look at hists by condition:
hist(rcsSubLevelWide_clean$rdmRoundsIndepNumeric[rcsSubLevelWide_clean$condCode==1], breaks=seq(from=0.5, to = 7.5, by = 1), main= "RDM round independence\nnat-nat", xlab="independence ratings (1-7)"); 
hist(rcsSubLevelWide_clean$rdmRoundsIndepNumeric[rcsSubLevelWide_clean$condCode==2], breaks=seq(from=0.5, to = 7.5, by = 1), main= "RDM round independence\nnat-strat", xlab="independence ratings (1-7)")
hist(rcsSubLevelWide_clean$rdmRoundsIndepNumeric[rcsSubLevelWide_clean$condCode==3], breaks=seq(from=0.5, to = 7.5, by = 1), main= "RDM round independence\nstrat-nat", xlab="independence ratings (1-7)")
hist(rcsSubLevelWide_clean$rdmRoundsIndepNumeric[rcsSubLevelWide_clean$condCode==4], breaks=seq(from=0.5, to = 7.5, by = 1), main= "RDM round independence\nstrat-strat", xlab="independence ratings (1-7)")
