...
# ERQ
 ...
 sd(rcsSubLevelWide_clean$ERQreapp, na.rm=T); # sd = 5.487901
 summary(rcsSubLevelWide_clean$ERQsupp); # range = 4 - 27; mean = 14.89; median = 15
 sd(rcsSubLevelWide_clean$ERQsupp, na.rm=T) # sd = 5.497102

#is complex span realted to ERQ 
cor.test(rcsSubLevelWide_clean$compositeSpanScore, rcsSubLevelWide_clean$ERQreapp); # r = .032(97), p = .75
cor.test(rcsSubLevelWide_clean$compositeSpanScore, rcsSubLevelWide_clean$ERQsupp); # r = .045(97), p = .66
...
cor.test(rcsSubLevelWide_clean$ERQreapp, rcsSubLevelWide_clean$ERQsupp, paired=T); #r = -.07(120), p =.4

cor.test(rcsSubLevelWide_clean$ERQreapp, rcsSubLevelWide_clean$motivationNumeric, paired=T); #r = -.03(120), p =.75
cor.test(rcsSubLevelWide_clean$ERQsupp, rcsSubLevelWide_clean$motivationNumeric, paired=T); #r = -.22(120), p =.01
...
# base model 1
pocShiftEarnExp_ERQxStratyOnly = glm(choice~0 + pastOC1sc*strategyRecode + signedShiftsc*strategyRecode + earnNormalizedOverall*strategyRecode + linExpectation*strategyRecode + suppSpan0*strategyRecode + reapSpan0*strategyRecode, data=rdmDFclean, family="binomial",offset=predModel2);
...
# base model 2
pocShiftEarnExp_pocIntnx_ERQxStratOnly = glm(choice~0 + pastOC1sc*linExpectation*strategyRecode + signedShiftsc*strategyRecode + pastOC1sc*earnNormalizedOverall*strategyRecode + suppSpan0*strategyRecode + reapSpan0*strategyRecode, data=rdmDFclean, family="binomial",offset=predModel2);
...
# base model 1
pocShiftEarnExp_ERQreapXstratOnly = glm(choice~0 + pastOC1sc*strategyRecode + signedShiftsc*strategyRecode + earnNormalizedOverall*strategyRecode + linExpectation*strategyRecode + reapSpan0*strategyRecode, data=rdmDFclean, family="binomial",offset=predModel2);
...
# base model 2
pocShiftEarnExp_pocIntnx_ERQreapXstratOnly = glm(choice~0 + pastOC1sc*linExpectation*strategyRecode + signedShiftsc*strategyRecode + pastOC1sc*earnNormalizedOverall*strategyRecode + reapSpan0*strategyRecode, data=rdmDFclean, family="binomial",offset=predModel2);
...
# base model 1
pocShiftEarnExp_ERQreapXstrat_3timescales = glm(choice~0 + pastOC1sc*strategyRecode*reapSpan0 + signedShiftsc*strategyRecode*reapSpan0 + earnNormalizedOverall*strategyRecode*reapSpan0 + linExpectation*strategyRecode*reapSpan0, data=rdmDFclean, family="binomial",offset=predModel2);
...
# base model 2
pocShiftEarnExp_pocIntnx_ERQreapXstrat_3timescales = glm(choice~0 + pastOC1sc*linExpectation*strategyRecode*reapSpan0 + signedShiftsc*strategyRecode*reapSpan0 + pastOC1sc*earnNormalizedOverall*strategyRecode*reapSpan0, data=rdmDFclean, family="binomial",offset=predModel2);
...
# similar to base model 1 right above: poc x strat, poc x reap, strat x erq, and 3-way bt poc x strat x reap
...
# base model 1
pocShiftEarnExp_ERQreapXstratXpoc = glm(choice~0 + pastOC1sc*strategyRecode*reapSpan0 + signedShiftsc*strategyRecode + earnNormalizedOverall*strategyRecode + linExpectation*strategyRecode, data=rdmDFclean, family="binomial",offset=predModel2);
...
# still seeing interaction betwen poc x strat, strat x reap, strat x poc x reap
...
# base model 2:
pocShiftEarnExp_pocIntnx_ERQreapXstratXpoc = glm(choice~0 + pastOC1sc*strategyRecode*reapSpan0 + linExpectation*pastOC1sc + signedShiftsc*strategyRecode + pastOC1sc*earnNormalizedOverall, data=rdmDFclean, family="binomial",offset=predModel2);
...
summary(rcsSubLevelWide_clean$ERQreapp)
...
-0.188832 + 0.376590*-1 # -0.565422 natural
-0.188832 + 0.376590*1 #  0.187758 strategy  

# HIGH: poc + poc x strategy (+1/-1) + poc x high + poc x high x strategy (+1/-1)
-0.188832 + 0.376590*-1 + 0.175040 + -0.193435*-1 # -0.196947 natural
-0.188832 + 0.376590*1 + 0.175040 + -0.193435*1 # 0.169363 strategy
...
-0.188832 + 0.376590*-1 + -0.196764 + -0.622534*-1 # natural -0.139652
-0.188832 + 0.376590*1 + -0.196764 + -0.622534* 1 # strategy -0.63154
...
# PLOT THESE RESULTS: THESE ARE FROM MODEL BEFORE...NEED TO UPDATE 
...
lowreapdf = rcsSubLevelWide_clean[rcsSubLevelWide_clean$reapSpan0 <=thirdSplit[1],]
modhighreapdf = rcsSubLevelWide_clean[rcsSubLevelWide_clean$reapSpan0 >thirdSplit[1],]
...
plot(rcsSubLevelWide_clean$reapSpan0, pocStratIndiv)

pocStratIndiv_pocRanef = modelcoef_pocranef$subID$`pastOC1sc:strategyRecode`
plot(rcsSubLevelWide_clean$reapSpan0, pocStratIndiv_pocRanef)
...
# base model 1:
pocShiftEarnExp_suppression = glm(choice~0+pastOC1sc*strategyRecode + signedShiftsc*strategyRecode + earnNormalizedOverall*strategyRecode + linExpectation*strategyRecode + strategyRecode*suppSpan0, data=rdmDFclean, family="binomial", offset=predModel2);
...
pocShiftEarnExp_suppression3timescales = glm(choice~0+pastOC1sc*strategyRecode*suppSpan0 + signedShiftsc*strategyRecode*suppSpan0 + earnNormalizedOverall*strategyRecode*suppSpan0 + linExpectation*strategyRecode*suppSpan0, data=rdmDFclean, family="binomial", offset=predModel2);
summary(pocShiftEarnExp_suppression3timescales);
# AIC = 29769; worse AIC than above
...
RTvariabiltiy = as.data.frame(matrix(data=NA, nrow=nSub, ncol=6, dimnames = list(c(NULL), c("bin1", "bin2", "bin3", "bin4", "bin5", "bin6"))))

for (s in 1:nSub) {
  subdata = rdmDFclean[rdmDFclean$subID==subIDchar[s],]
  
  RTvariabiltiy$bin1[s] = var(subdata$RT[subdata$roundRDM==1 & subdata$trial %in% c(1:43)])
  RTvariabiltiy$bin2[s] = var(subdata$RT[subdata$roundRDM==1 & subdata$trial %in% c(44:87)])
  RTvariabiltiy$bin3[s] = var(subdata$RT[subdata$roundRDM==1 & subdata$trial %in% c(88:131)])

  RTvariabiltiy$bin4[s] = var(subdata$RT[subdata$roundRDM==2 & subdata$trial %in% c(1:43)])
  RTvariabiltiy$bin5[s] = var(subdata$RT[subdata$roundRDM==2 & subdata$trial %in% c(44:87)])
  RTvariabiltiy$bin6[s] = var(subdata$RT[subdata$roundRDM==2 & subdata$trial %in% c(88:131)])
}

par(mfrow = c(2,3))
plot(RTvariabiltiy$bin1, ylim=c(0, .85), ylab="RT variability", main="Bin 1: Trials 1-43\nRound 1", xlab="participant", pch=16, lwd=4, col="red")
plot(RTvariabiltiy$bin2, ylim=c(0, .85), ylab="RT variability", main="Bin 2: Trials 44-87\nRound 1", xlab="participant", pch=16, lwd=4, col="blue")
plot(RTvariabiltiy$bin3, ylim=c(0, .85), ylab="RT variability", main="Bin 3: Trials 88-131\nRound 1", xlab="participant", pch=16, lwd=4, col="green")
plot(RTvariabiltiy$bin4, ylim=c(0, .85), ylab="RT variability", main="Bin 1: Trials 1-43\nRound 2", xlab="participant", pch=17, lwd=4, col="red")
plot(RTvariabiltiy$bin5, ylim=c(0, .85), ylab="RT variability", main="Bin 2: Trials 44-87\nRound 2", xlab="participant", pch=17, lwd=4, col="blue")
plot(RTvariabiltiy$bin6, ylim=c(0, .85), ylab="RT variability", main="Bin 3: Trials 88-131\nRound 2", xlab="participant", pch=17, lwd=4, col="green")

# calculate variability in RT within each bin for each participant. Then take the mean variability across people.

par(mfrow=c(1,1))
plot(colMeans(RTvariabiltiy), ylim=c(0,.3), main="RT variability across gambling task rounds", xlab="Bins\nRound 1 = 1-3; Round 2 = 4-6", ylab="mean RT variability", axes=F, pch=c(16,16, 16, 17,17,17), col = c("red", "blue", "green", "red", "blue", "green"))
