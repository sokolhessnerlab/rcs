...
# ERQ REAPPRAISAL
model6_b_reappraisalOnly = glm(choice~0+pastOC1sc*strategyRecode + signedShiftsc*strategyRecode + earnNormalizedOverall*strategyRecode + linExpectation*strategyRecode + strategyRecode*reapSpan0, data=rdmDFclean, family="binomial", offset=predModel1);
