...
passFailCategories = c("subID","missT", "missACs", "pgamble", "glm"); # column names
...
round1passfail$total=rowSums(round1passfail[2:5]); # range = 3-4; mean = 3.88
round2passfail$total=rowSums(round2passfail[2:5]); # range = 3-4; mean = 3.79
...
excludeCutOff = 3; # we are only keeping those with totals at or above this number
...
rdmDFclean = rdmDF[which(!rdmDF$subID %in% excludeSubID),]
