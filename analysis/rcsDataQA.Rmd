...
rdmExclude = as.data.frame(matrix(data=NA, nrow = nSub, ncol=3, dimnames=list(c(NULL), c("subID", "round1Exclude", "round2Exclude"))));
...
cbind(rdmExclude, ERQexclude$ERQexclude, complexSpanExclude$ospanExclude, complexSpanExclude$symspanExclude )
