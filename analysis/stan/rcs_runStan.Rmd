...
#stanModel = "/Users/hayley/Documents/GitHub/rcs/analysis/stan/rcs_practiceStan.stan"
...
save(stanModel,sflistFinal, file = sprintf('rcs_basicRhoMu_%s.Rdata',format(Sys.Date(), format="%Y%m%d")))
