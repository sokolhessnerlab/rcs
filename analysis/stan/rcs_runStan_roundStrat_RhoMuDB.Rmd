...
save(stanModel,sflistFinal, file = sprintf('/Volumes/shlab/Projects/RCS/data/Rdata/stanModelOutput/rcs_roundStrategy_rhoMuDB_changeDB_%s.Rdata',format(Sys.Date(), format="%Y%m%d")))
