...
stanModel = "/Users/Shlab/Documents/Github/rcs/analysis/stan/rcs_roundStrategy_rhomudb.stan"
```
...
save(stanModel,sflistFinal, file = sprintf('/Volumes/shlab/Projects/RCS/data/Rdata/stanModelOutput/rcs_roundStrategy_rhoMuDB_%s.Rdata',format(Sys.Date(), format="%Y%m%d")))
